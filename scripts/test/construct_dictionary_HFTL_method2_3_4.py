# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 17:44:21 2023
...
train_herbarium_txt = "path/to/dictionary_method2_herbarium.txt"
train_field_txt = "path/to/dictionary_method2_field.txt"
...
#   field
train_anchor_paths_f, train_anchor_fam_lbls_f, train_anchor_gen_lbls_f, train_anchor_spe_lbls_f = read_txt(train_field_txt)
dictionary_field = {}
for spe, path in zip(train_anchor_spe_lbls_f, train_anchor_paths_f):
    if spe not in dictionary_field:
        dictionary_field[spe] = []
    dictionary_field[spe].append(path)
...
with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
    ...
    for key in range(numclasses1):        
        ...
        if key in dictionary_field:
            USE_FIELD = True
            key_paths = dictionary_field[key]
            print("FIELD key paths len:", len(key_paths))
